...
There's a sharper version of that mistake worth calling out on its own. If your organization is past the earliest stage and the honest answer to "who actually delivers value to customers" is "the four-person forward deployed team," that isn't a resourcing gap. It's a product and engineering problem wearing a resourcing costume. A small team, usually paid less than the core engineers they sit next to, is not supposed to be the linchpin between your product and your revenue. If it is, the platform isn't doing its job, and hiring more forward deployed engineers treats the symptom instead of the cause. The question isn't how you scale the skunkworks team. It's why closing deals depends on the skunkworks team at all.
...
There's a concrete tell buried in that mistake, independent of headcount: which function forward deployed engineering reports into. Report into engineering, and the team inherits engineering's backlog of things nobody else wants to own, the buffer resource for whatever product and engineering haven't gotten to or don't have the clarity to prioritize. Report into go-to-market, with a real bridge into engineering's roadmap through the architect tier above, and the team's job stays what it's supposed to be: last-mile delivery, not last-resort ownership. If you want a single question to check an FDE org against, this is it.
