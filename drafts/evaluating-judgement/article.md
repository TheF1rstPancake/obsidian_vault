...
Netflix comes closest to this framing — they explicitly list "distinguishing what must be done now from what can wait" as a component of judgment in their [culture doc](https://jobs.netflix.com/culture). But they stop at listing it. The framework here treats prioritization as a first-class pillar, equal to motivation and technical skill, and argues you have to operationalize all three to actually screen for it.
