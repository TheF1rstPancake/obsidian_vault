...
A lot of people have two of these. Some only have one. People with genuinely good judgement have all three. Strip out any one and "judgement" collapses.

## Why these three (and not five)

You might be wondering where "communication" or "empathy" go. They're inside technical skill, not alongside it.

When I say technical skill I don't mean "hands on the keyboard." I mean *any learnable competency the role requires*. For a sales engineer that's product knowledge plus customer empathy plus solution design. For a designer it's visual hierarchy plus user research plus critique-giving. For a manager it's running 1:1s plus written feedback plus delivering hard performance conversations. Communication, empathy, conflict navigation — those are skills, and skills can be learned with reps. That's exactly what puts them in this pillar.

The three pillars are deliberately *meta-skills*. Prioritization and motivation aren't job-specific — they apply to engineers, salespeople, designers, and chiefs of staff alike. Technical skill is the bucket for everything that *is* job-specific. The reason it's three and not five is that these are the only three you can't substitute for one another. Pile up all the empathy in the world and you won't compensate for someone who can't prioritize.
...
Once you have the three pillars, your interview loop should explicitly target each one. Most loops already cover two of the three, badly.
...
**The question:** "Walk me through how you'd sequence these five things [give them five real-ish competing priorities from the role]. Now I'm going to change one constraint — what shifts?"

**Good answer:** rationale per item. Distinguishes urgent from important. Surfaces dependencies you didn't mention. When you change the constraint, they re-rank with reasoning and tell you what they'd deprioritize entirely. Often sounds like: "if X is true, then Y and Z swap, and I'd actually drop W."

**Bad answer:** sequences by gut, can't defend the order under pressure, treats your constraint change as a minor edit ("I'd still do most of it the same way"). They see priorities as a to-do list, not a set of tradeoffs under uncertainty.

**Red flag:** "I'd ask my manager to help me sort it."
...
That's what "good judgement" actually means. And once you can name the three pieces, you can stop using the phrase as a vibe check and start hiring for it on purpose.
