...
Being helpful on the surface means being curious and exploratory. Putting it into practice is solution-agnostic requirement gathering.
...
Solution-agnostic means you aren't just parroting back the problem. You are taking the time to help the customer clarify what *they* think their ideal solution and requirements are. How would they approach it if they could? Their answer might be a shrug (*that's why I'm talking to you*) and that's fine. But you have to pause and ask. When you don't, the only move left is the spec sheet: you read the customer a list of capabilities and hope they can connect the dots back to their own problem. The role of a "solutions" team in any capacity is to help the customer *do that mapping of their problem, to your solution.* You can give the most technically accurate, robust description of your platform and still lose, because the customer was confused about how it connected to what they actually needed or wanted. If you leave it up to the customer, you are rolling the dice, and not in your favor.

The best test: can they take your solution-agnostic requirements and use them to evaluate your solution *and* others in the market? That's how you know you've documented what they need, not just what's right for you.

### The four boxes

People say "discovery is so important" all the time and like most things, it's _good_ discovery that matters. There are four data points that, together, form a problem statement. These four boxes have *nothing to do with you*.[^meddicc] They have everything to do with the customer:
...
This is also where the distinction between *understanding the customer's problem* and *understanding the customer* shows up. The problem is easy: what's broken today. The customer is harder: their idiosyncrasies, motivations, rationale, context. People flounder here because the prospect throws out a string of requirements that are deeply rooted in their organizational context that you often won't understand, and the seller feels pressure to show, one by one, how the product checks each box. So they fall back to the spec sheet, walking through every button on the page, hoping the customer will connect the dots.
...
- The fifth box (the solution-agnostic technical requirements that bridge the customer's ideal solution to your platform, letting you say 'our solution can do these')
...
There is a way to do this scalably. If you know which goals/outcomes lead you to recommend certain solutions, you should also know the reverse: which package of requirements ladders back up to which goals/outcomes. That's the foundation of an [AI-native SE stack](/ai-native-se-stack/).
...
Are they reading the spec sheet? Word-vomiting what the product is capable of? Or do they take a beat to actually understand what the customer is trying to do, packaging it back in their own language, before moving forward into the 7,000 ways we can help?
...
[^learning]: You should always be learning. Showing your work internally, for your own development and your team's, is a necessity. Your customers just don't care what you learned. They care whether they got what they needed.
...
[^meddicc]: Readers familiar with enterprise sales frameworks like MEDDICC will recognize this shape. The four boxes here are deliberately simplified, focused on the customer's story rather than the seller's qualification criteria.
